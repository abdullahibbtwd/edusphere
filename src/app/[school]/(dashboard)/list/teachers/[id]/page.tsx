  ...
  return (
    <div className="flex-1 p-4 flex flex-col gap-4 xl:flex-row ">
          ...
          <div className="flex-1 flex gap-3 justify-between flex-wrap">
            ...
            <div className="w-full bg-white p-4 rounded-md  md:w-[48%] xl:w-[45%] 2xl:w-[48%] flex gap-4 items-center">
              ...
              <div className="flex flex-col items-start gap-1">
                ...
                <span className="text-xs text-gray-700">Lessons</span>
              </div>
            </div>
            <div className="w-full bg-white p-4 rounded-md  md:w-[48%] xl:w-[45%] 2xl:w-[48%] flex gap-4 items-center">
              <Image
              ...
              <div className="flex flex-col items-start gap-1">
                <h1 className="text-xl font-semibold">6</h1>
                <span className="text-xs text-gray-700">Clases</span>
              </div>
            </div>
            <div className="w-full bg-white p-4 rounded-md  md:w-[48%] xl:w-[45%] 2xl:w-[48%] flex gap-4 items-center">
              <Image
              ...
              <div className="flex flex-col items-start gap-1">
                ...
                <span className="text-xs text-gray-700">Branches</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white p-4 rounded-md ">
            ...
            <Link className="p-3 rounded-md bg-[#EDF9F0]" href='/'>Teacher&apos;s Classes</Link>  
            <Link className="p-3 rounded-md bg-[#C3EBFA]" href='/'>Teacher&apos;s Student</Link>  
            <Link className="p-3 rounded-md bg-[#FEFCEB]" href='/'>Teacher&apos;s Lessons</Link>  
            <Link className="p-3 rounded-md bg-[#CFCEFF]" href='/'>Teacher&apos;s Exams</Link>  
            <Link className="p-3 rounded-md bg-[#CFCEFF]" href='/'>Teacher&apos;s Assignment</Link>  
